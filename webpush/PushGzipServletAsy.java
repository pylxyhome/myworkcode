...
/**
 * 接收群发任务servlet接口,gzip版
 * @description
 * @author panyl 
 * @date 2011-11-30
 */
public class PushGzipServletAsy extends HttpServlet {
	private static final long serialVersionUID = 115267641048173901L;

	private final static Logger log = LoggerFactory
			.getLogger(PushGzipServletAsy.class);
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		long taskid=taskService.putIntoReadFileGzip(msg, push_url, inStream);
