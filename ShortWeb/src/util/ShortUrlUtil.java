...
public class ShortUrlUtil {
    ...
    * @return
    */
   public static String getFirstShortUrl(String url){
	   return getShortUrl(url,0);
   }
   public static String getShortUrl(String url,int index){
	   if(index>3||index<0)return "";
	   return shortUrl(url)[index];
   }
