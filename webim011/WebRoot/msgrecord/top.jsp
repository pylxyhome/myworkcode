...
%>
<HTML><HEAD><base href="${basePath}"/><TITLE>Untitled Document</TITLE>
...
<TABLE style="MARGIN: 0px; background:url(images/topbg.jpg) 0 -3px repeat-x" cellSpacing=0 cellPadding=0 width="100%" 
bgColor=#6386de border=0 valign="top">
  <TBODY>
 
  <TR vAlign=top>
      <TD id="topbg"  vAlign=top width="450" class="My" Align=left><img style="margin-left: 10" src="images/Logo.jpg" border=0 /></TD>
    <TD width="124">
      <TABLE style="MARGIN: 0px" height="100%" cellSpacing=0 cellPadding=0 
      bgColor=#6386de border=0>
        <TBODY></TBODY></TABLE></TD>
    <TD align=right width=611>
      <TABLE id="toolbarbg" style="MARGIN: 0px" height="100%" cellSpacing=0 cellPadding=0 
       border=0>
        <TBODY>
        <TR vAlign=bottom height=20>
          <TD width=18><br></TD>
            ...
            <TD class=top bgColor=#000000><NOBR></NOBR></TD>
            </TR>
        <TR height=38>
          <TD></TD>
          <TD vAlign=center align=right>
          	<span>
			      <A  onmouseover="MM_nbGroup('over','OAHeader_r1_c0','images/OAHeader_r1_c0_f2.gif','images/OAHeader_r1_c0_f3.gif',1);" 
            title="网站首页" style="CURSOR: hand; margin-right:14px;" 
            onmouseout="MM_nbGroup('out');" href="${basePath}"  target="_blank"><IMG id=OAHeader_r1_c0 
            src="images/OAHeader_r1_c0.gif" border=0  name=OAHeader_r1_c0></A>
            </SPAN>
			     
          <IMG id=OAHeader_r1_c3 
            src="images/OAHeader_r1_c3.gif" border=0  name=OAHeader_r1_c3 />&nbsp; 
            <A 
            ...
            href="javascript:parent.right.location.reload()"><IMG 
            src="images/OAHeader_r1_c5.gif" border=0 
            name=OAHeader_r1_c5></A> &nbsp; 
            <A 
            ...
            src="images/OAHeader_r1_c9.gif" border=0  name=OAHeader_r1_c9></A> &nbsp; 
            <A 
